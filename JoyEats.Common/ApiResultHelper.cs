namespace JoyEats.Common
{
    ...
    public class ApiResultHelper
    {
        ...
        /// <returns></returns>
        public static ApiResult<T> Success<T>(T data, string message = "操作成功", int code = 200)
        {
        ...
        /// <param name="code"></param>
        /// <returns></returns>
        public static ApiResult Success(string message = "操作成功", int code = 200)
        {
        ...
        /// <returns></returns>
        public static ApiResult<T> Error<T>(string message, int code = 500, string errorDetail = null)
        {
        ...
        /// <param name="errorDetail"></param>
        /// <returns></returns>
        public static ApiResult Error(string message, int code = 500, string errorDetail = null)
        {
